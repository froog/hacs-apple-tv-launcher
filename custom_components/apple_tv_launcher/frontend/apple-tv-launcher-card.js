...
async function Ke(e, t, n) {
	...
	try {
		...
		if (e) {
			...
			if (Ge(i)) {
				let e = i.artwork;
				return e.trackId && (e.primary = await X(n, e.trackId, t) ?? Y(e.trackId, t)), e;
			}
...
async function qe(e, t, n) {
	...
	if (!e.id) return e;
	for (let r of We(e.id, t.artwork_country)) {
		let t = await Ke(e.id, r, n);
		if (t) return {
			...e,
			artwork: t.primary,
...
function Ye(e) {
	...
	return {
		...
		columns: Q(e.columns, 2, 10, Z.columns),
		mobile_columns: Q(e.mobile_columns, 2, 6, Z.mobile_columns),
		show_labels: $(e.show_labels, Z.show_labels),
		artwork_lookup: $(e.artwork_lookup, Z.artwork_lookup),
		artwork_country: /^[a-z]{2}$/.test(t) ? t : Z.artwork_country,
		wake_before_launch: $(e.wake_before_launch, Z.wake_before_launch),
		wake_delay: Q(e.wake_delay, 0, 15e3, Z.wake_delay),
		retry: $(e.retry, Z.retry),
...
function nt() {
	...
	return typeof e == "string" && /^[A-Za-z]{2}$/.test(e) ? e.toLowerCase() : Z.artwork_country;
}
...
var st = class extends B {
	...
	async _loadApps(e) {
		...
		let i = await Promise.all(r.map((e) => qe(e, n, t)));
	...
	_renderApp(e, t) {
		let [n, r] = Ue(e.name), i = t.toLocaleLowerCase() === e.name.toLocaleLowerCase(), a = this._launching === e.name;
		return j`
      <button
        class=${W({
			app: !0,
